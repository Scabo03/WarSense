...
Fino a ieri il gioco aveva una cosa sola: uno scontro. Da oggi ne ha due. Lo
scontro è dov'era e non è stato toccato in nulla; accanto è comparsa **la mappa
di campagna**, cioè il piano su cui gli eserciti si spostano nei giorni prima di
incontrarsi.

Questa è la prima puntata. La mappa si percorre e si capisce, e i gruppi si
muovono: nient'altro. Non ci sono ancora rifornimenti, provviste, stanchezza,
inverno, avversario, imboscate, battaglie che si innescano. Arriveranno; era
importante che il modo di orientarsi funzionasse prima che ci si costruisse sopra.

## Dalla schermata iniziale

Trovi tre voci nuove:
...
azioni (scorrimento in su o in giù per trovarle). Non ci sono diagonali: una
casella ha al massimo quattro vicine.
...
Attivi la casella di un tuo gruppo. Si apre un pannello con due voci:

- **Marcia** — poi vai sulla casella dove vuoi andare e la attivi. Se cambi idea,
  il gesto di fuga annulla.
- **Presidia** — il gruppo resta fermo in guardia.
...
2. **Il rotore «Gruppi da muovere»** salta direttamente al prossimo gruppo che
   ...
   una mappa grande con cinque gruppi chiudere una giornata costa 15 gesti con il
   salto e 109 senza.
3. **Il registro della campagna**, il primo comando sotto la mappa: elenca ciò che
   ...
   Per adesso contiene solo l'apertura delle giornate, perché non è ancora successo
...
**La domanda più importante è una sola: dopo cinque o sei giornate, sai dove sono
le cose?** Non se riesci a trovarle riesplorando, ma se ce le hai in testa: dove
...
1. **Comincia dalla mappa piccola**, poi la media, poi la grande. La piccola si
   impara in una giornata.
2. **Il salto ai gruppi da muovere**: verifica che li passi tutti, che non ne
   ripeta nessuno e che riparta dal primo quando ha finito il giro.
3. **La lunghezza degli annunci di casella**: sulla mappa media, dove ci sono
...
4. **La chiusura della giornata**: quando dai l'ordine all'ultimo gruppo, la
   giornata si chiude da sé e il giorno avanza. L'ho lasciata senza suono e senza
   vibrazione proprii, perché arriva sempre subito dopo il segnale di conferma
   dell'ordine. Se ti sfugge, dimmelo: si cambia.
5. **Le voci del registro non si attivano.** Per adesso è giusto così: sono voci di
   calendario e non hanno un luogo dove portarti. Quando ci saranno fatti con un
   luogo — un'imboscata, un rifornimento tagliato — attivandole ti porteranno lì.
   Dimmi se, non attivandosi, sembrano rotte.

## Una cosa che ho deciso io e che potresti volere diversa

L'incarico diceva che la giornata si chiude «su comando del giocatore». Il
documento di progetto dice invece, per iscritto, che si chiude da sé quando tutti i
gruppi hanno agito e che un comando di fine giornata non esiste. Ho seguito il
documento, perché è una decisione già presa, e ho letto la frase dell'incarico
come «si chiude per effetto dei tuoi ordini, mai per iniziativa del programma» —
che è vero: nessun gruppo fa niente da solo.
