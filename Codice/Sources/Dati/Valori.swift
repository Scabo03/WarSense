...
public struct ParametriCombattimento: Codable, Hashable, Sendable {
    ...
    /// I due estremi della curva del tiro (01 §9.10.1, 03 §5.15): la resa al limite
    /// della gittata, dove il tiro disturba, e quella alla minima distanza, dove
    /// uccide. Fra i due la formula unica interpola sulla prossimità.
    public let resaTiroAlLimite: Scalato
    public let resaTiroAllaMinimaDistanza: Scalato
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case resaTiroAlLimite = "resa_tiro_al_limite"
        case resaTiroAllaMinimaDistanza = "resa_tiro_alla_minima_distanza"
