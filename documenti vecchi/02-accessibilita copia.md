...
Documento 02 di 05 — versione 1.1
...
3.7.2 Due gittate. Poiché ogni arma da tiro possiede una gittata di disturbo e una di pericolosità secondo il punto 3.4.1 del documento 01, la disponibilità di un bersaglio non è più binaria. Da definire il modo esatto in cui la distinzione viene annunciata, con il vincolo che l'annuncio di cella nel livello sintetico resti dell'ordine di poche parole e che i due stati appartengano al vocabolario chiuso della sezione 4.
...
4.4.1 Il vocabolario chiuso si estende ai seguenti insiemi introdotti dalle regole di gioco consolidate. Stati di gittata rispetto a un bersaglio, secondo il punto 3.7.2. Stato di controllo di un reparto, cioè se sia disponibile agli ordini oppure impegnato a contatto secondo il punto 9.5 del documento 01. Stato della dotazione di munizioni. Stagione in corso, secondo il punto 5.9 del documento 01. Caratteristica del campo di battaglia, secondo il punto 7.4 del documento 01. Da definire i termini di ciascun insieme, con il vincolo di invariabilità del punto 4.1.
...
6.5.1 Poiché ciascun gruppo dispone di un'azione al giorno secondo il punto 5.6 del documento 01, l'informazione di stato della campagna dichiara quanti gruppi abbiano già agito nel turno e quanti no. Fra esploratori, colonna principale e distaccamenti il numero dei gruppi da seguire cresce rapidamente, e ricostruire per tentativi quali abbiano già agito è precisamente il tipo di operazione che il punto 1.2 vieta. Da definire il formato esatto dell'annuncio e il modo di raggiungere direttamente i gruppi ancora inattivi, che è materia del rotore di cui al punto 7.3.
...
7.3 Elenco proposto per la mappa di campagna: le proprie formazioni, i propri gruppi che non hanno ancora agito nel turno, le formazioni avversarie note, le installazioni e le piazzeforti, le caselle da cui è possibile esplorare, le caselle boscose in cui è possibile costruire, le informazioni di ricognizione scadute, le battaglie in sospeso in tutte le campagne, gli eventi del turno.
...
9.3 Ordine di tiro. Poiché il tiro non è un automatismo e la dotazione è limitata secondo i punti 3.4.3 e 9.6 del documento 01, far tirare un reparto è un'operazione esplicita che il giocatore compie o omette a ogni turno. Il pannello della cella dichiara la dotazione residua, la gittata entro cui si trova il bersaglio e l'effetto che ne consegue.
...
17.1 Da definire prima della realizzazione della parte corrispondente. I gradi e i termini che esprimono la probabilità, punto 4.4. I termini dei nuovi insiemi del vocabolario chiuso, cioè stati di gittata, stato di controllo di un reparto, dotazione di munizioni, stagione e caratteristica del campo, punto 4.4.1. Il modo in cui viene annunciata la distinzione fra gittata di disturbo e gittata di pericolosità, punto 3.7.2. Il formato dell'annuncio dei gruppi che hanno già agito nel turno, punto 6.5.1. La sequenza di interazione tra due celle e la gestione dei bersagli, punto 9.2. L'assegnazione dei significati ai pattern tattili, punto 11.7. Le preferenze aggiuntive nelle impostazioni, punto 14.3.
...
17.2.1 Il tetto di dodici o quindici significati tattili del punto 11.5 va verificato a fronte degli eventi introdotti dalle regole consolidate, in particolare disingaggio di un reparto, esaurimento delle munizioni, scatto di un'imboscata, sortita da una piazzaforte bloccata, passaggio di stagione. Se l'insieme degli eventi meritevoli di segnale eccede il tetto, prevale il tetto e la selezione va compiuta in sede di assegnazione secondo il punto 11.7.
