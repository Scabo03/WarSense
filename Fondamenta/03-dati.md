...
Documento 03 di 05 — versione 2.3
...
6.10.3 Da osservare in taratura, emerso dalla stessa misura: oltre il secondo assalitore il costo dell'accerchiamento per chi lo compie non cresce più, poiché il bersaglio non risponde dal terzo in poi. Aggiungere reparti su un bersaglio già stretto è quindi, in sé, sempre conveniente. Il freno non è nel combattimento ma nel volume speso per portarveli e nei fianchi che si scoprono altrove; è precisamente ciò che le simulazioni devono verificare, perché è l'unico argine all'ammassamento. Fonte: documento 01, punti 9.10.1, 9.10.2, 9.11, 9.11.5 e 16.4.
