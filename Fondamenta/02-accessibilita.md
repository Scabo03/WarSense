...
Documento 02 di 05 — versione 2.1
...
3.7.2 Due gittate. Poiché ogni arma da tiro possiede una gittata di disturbo e una di pericolosità secondo il punto 3.4.1 del documento 01, la disponibilità di un bersaglio non è più binaria. Chiuso nella fase di architettura: quando un proprio reparto da tiro è selezionato o attivo, ogni bersaglio raggiungibile si annuncia con uno dei termini chiusi del punto 4.4.5, cioè a tiro utile oppure a tiro di disturbo, collocato subito dopo la testa fissa; ciò che non è raggiungibile non riceve alcun termine di gittata. Nel pannello dell'ordine di tiro il termine di gittata compare insieme alla dotazione residua e all'efficacia secondo il punto 9.3. Nel livello sintetico l'annuncio resta di poche parole: il termine di gittata è una di esse.
