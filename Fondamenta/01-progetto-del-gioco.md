...
Documento 01 di 05 — versione 3.7

Novità della versione 3.7, per decisione del titolare dopo la misura sull'ordine dei turni. Cambia il MOMENTO in cui i contatti si risolvono: uno scontro si risolve nell'istante in cui si forma, e non più insieme a tutti gli altri alla fine del giro (9.7.1). L'ordine dei turni non si tocca: resta in vigore che muove per primo chi occupava per primo la casella (9.4.1). Ne discendono le riformulazioni di 9.10.2.3 e 9.11.1, che presupponevano una simultaneità fra risoluzioni diverse dello stesso turno e che ora non esiste più, e la precisazione 9.8.5 sul momento del disingaggio. È una modifica voluta e non la correzione di una svista.

Novità della versione 3.6, in conseguenza della prima taratura sui numeri della fase C. Una sola regola cambia, ed è la forma della curva del tiro (9.10.1): al limite della gittata il tiro non rende più quanto l'accoppiamento nudo ma MENO, cioè disturba, e cresce fino a rendere molto di più alla minima distanza, cioè a uccidere. Ne discende la riformulazione di 9.9.3, che dichiarava che i modificatori accrescono la resa e non la riducono mai. Si aggiunge inoltre la precisazione 15.2.3.1 sul modo di conclusione quando la ritirata è stata dichiarata, che il programma di verifica ha mostrato non essere quello voluto. Nessun valore entra in questo documento: i numeri della taratura stanno nel documento 03.

Novità della versione 3.5, per decisione del titolare. Si introduce il limite dei bersagli simultanei (nuova sezione 9.11): un reparto risponde ad al massimo due nemici — al primo per intero, al secondo con resa ridotta da un malus, dal terzo in poi per nulla — con i posti contati sull'ordine di arrivo del contatto e la successione automatica nei posti che si liberano. La modifica è voluta e sostituisce il comportamento precedente, in cui l'accerchiato combatteva a piena resa in ciascun contatto; ne discendono la riformulazione di 9.7, che parlava di perdite sempre reciproche, e quella di 9.10.2.4, che dava per fermi i colpi dell'accerchiato. Si chiude inoltre il caso dell'annientamento simultaneo, che non può risolversi a sfavore del giocatore (nuovo punto 15.2.5) ed entra fra i vantaggi nascosti (13.2). Nessun'altra decisione della versione 3.4 è riaperta.

Novità della versione 3.4, per decisione del titolare dopo l'accertamento sugli esiti degli scontri condotto sulla build 6: si introducono due modificatori di posizione, raccolti nella nuova sezione 9.10 e richiamati dal nuovo punto 9.9.3. Il primo è la vicinanza nel tiro (9.10.1), che restituisce la sostanza della doppia gittata soppressa nella versione 3.3 senza restituirne il costo, cioè la scelta al momento del tiro; il secondo è l'accerchiamento (9.10.2), che accresce il danno quando più reparti agiscono contro il medesimo bersaglio, i tiratori compresi. Entrambi valgono per le due parti. In conseguenza del primo si corregge una formulazione della versione 3.3 divenuta inesatta: la resa del tiro non è più unica lungo la gittata, mentre la gittata resta una sola e la disponibilità del bersaglio resta binaria (nuovo punto 3.4.1.1). Nessun'altra decisione della versione 3.3 è riaperta; l'accertamento che ha preceduto queste aggiunte non ha trovato difetti nelle regole già scritte.
...
3.4.1 Gittata unica. Dalla versione 3.3, per decisione del titolare: la distinzione fra gittata di disturbo e gittata di pericolosità è soppressa. Ogni arma da tiro possiede una sola gittata utile; entro la gittata il tiro è possibile, oltre non lo è. Sparisce ogni scelta connessa alla distanza al momento del tiro: la disponibilità di un bersaglio è binaria, a portata oppure fuori portata. Il peso della decisione di quando sparare resta intatto perché la dotazione è limitata e non reintegrabile (3.4.3): si decide se spendere una scarica ora o conservarla, non a quale distanza valga.

3.4.1.1 Precisazione della versione 3.4, che non riapre la 3.4.1 ma ne corregge una formulazione divenuta inesatta. La versione 3.3 diceva «una sola gittata e una sola resa», e quella seconda metà cade con il modificatore di vicinanza del punto 9.10.1: la gittata resta una sola e la disponibilità del bersaglio resta binaria, ma la resa non è più unica, poiché cresce al diminuire della distanza. Ciò che la 3.3 sopprimeva era la SCELTA al momento del tiro, e quella resta soppressa: l'azione di tiro è una sola, l'annuncio non guadagna alcuna voce da selezionare, e la distanza è una conseguenza della posizione e non una decisione presa allo scatto. Il costo della doppia gittata era la scelta; la sua sostanza era che la distanza contasse, e quella sostanza torna senza il costo.
...
9.7 Risoluzione della mischia. La mischia è continua: a ogni turno i reparti a contatto si infliggono perdite, e il contatto prosegue finché uno dei due è distrutto oppure si disingaggia secondo il punto 9.8. Poiché i reparti impegnati sono fuori controllo, ciò avviene senza che il giocatore decida alcunché.

9.7.0 Le perdite di un contatto non sono necessariamente reciproche, dalla versione 3.5. La versione 3.4 e le precedenti dicevano «perdite reciproche», e quella parola cade con il limite dei bersagli simultanei del punto 9.11: un reparto già impegnato con due nemici non risponde al terzo, il cui contatto produce quindi perdite in una direzione sola. La riformulazione è voluta e non corregge una svista.

9.7.1 Momento della risoluzione, riscritto nella versione 3.7. Un contatto si risolve DUE volte in due occasioni distinte: nell'istante in cui si forma, e poi all'inizio di ciascun giro nuovo per tutto il tempo in cui dura. Chi ingaggia e chi è ingaggiato si scambiano quindi i colpi subito, senza attendere che entrambe le parti abbiano finito di agire; e la mischia che non si scioglie continua a produrre effetti giro dopo giro, come la versione precedente già voleva.

9.7.1.1 Perché è cambiato. Con la risoluzione rinviata alla fine del giro, chi si impegnava per primo consegnava all'avversario l'ultima parola: l'avversario poteva portare altri nemici addosso al reparto impegnato prima che si scambiasse un solo colpo. La misura lo ha confermato in modo netto — a mazzi identici, stesso ufficiale e stessa condotta, chi muoveva per primo perdeva in ventuno configurazioni su ventiquattro — e il rimedio scelto dal titolare agisce sulla sequenza e non sull'ordine dei turni.

9.7.1.2 Che cosa NON è cambiato. La perdita di controllo del punto 9.5 resta intera: il reparto che ingaggia esce dal comando del giocatore dal momento del contatto, e la risoluzione immediata non lo restituisce. La mischia resta continua e non si esaurisce in un colpo solo. Il rilievo che aveva fatto scartare la risoluzione immediata nella versione precedente — che avrebbe ridotto la perdita di controllo a una formalità — non si applica a questa forma, in cui il contatto prosegue e si risolve di nuovo a ogni giro.

9.7.1.3 Conseguenza voluta e dichiarata: diventa significativo l'ordine in cui il giocatore muove i propri reparti dentro il proprio turno. Un reparto già logorato in un contatto risolto poco prima arriva indebolito al contatto successivo dello stesso turno. È profondità voluta; le informazioni per decidere sono quelle del punto 9.7.2 e del documento 02, punti 3.8.1 e 9.3.1, e sono disponibili prima dell'azione e non soltanto a cose fatte.

9.7.1.4 L'annuncio non è più per forza complessivo, poiché i contatti non avvengono più tutti insieme. La forma è materia del documento 02, punto 8.9, con il vincolo che l'esito segua immediatamente l'azione che lo ha causato senza che la somma degli esiti di un turno diventi una sequenza lunga da subire.
...
9.8.5 Momento del disingaggio, precisato nella versione 3.7. La soglia si valuta all'inizio del giro e non allo scambio immediato del punto 9.7.1: un reparto non può quindi ritrarsi nello stesso turno in cui gli è stato ordinato di attaccare, il che nessuna regola prevede e il punto 9.8.2 esclude, dichiarando che chi si sfila torna controllabile dal turno successivo. Lo scambio immediato infligge perdite; è il giro che decide chi non regge più.
...
9.9.3 All'esito dell'accoppiamento si applicano i modificatori della sezione 9.10. L'ordine è dichiarato: prima l'accoppiamento fra offesa e protezione, poi i modificatori, ciascuno come coefficiente di una formula unica secondo il punto 13.3 della carta. Nessun modificatore può rendere inefficace un'offesa che l'accoppiamento aveva reso efficace, e l'annuncio qualitativo del punto 9.9.1 continua a riferirsi al solo accoppiamento, che non dipende dalla posizione.

9.9.3.1 Dalla versione 3.6 un modificatore può anche RIDURRE la resa, e uno solo lo fa: la vicinanza nel tiro, che al limite della gittata rende meno dell'accoppiamento nudo (9.10.1). La versione 3.5 diceva che i modificatori «accrescono la resa e non la riducono mai», e quella formulazione cade. La riduzione è dichiarata, ha un solo luogo, e serve a distinguere il tiro che disturba da quello che uccide.

## 9 bis. Modificatori di posizione (sezione 9.10)

9.10 Introdotti nella versione 3.4 per decisione del titolare, dopo l'accertamento sugli esiti degli scontri. Sono due, valgono per entrambe le parti senza eccezione, e hanno in comune la natura: non sono decisioni prese al momento dell'azione, ma conseguenze della posizione in cui i reparti si trovano. Chi manovra bene li ottiene, chi non manovra non li ottiene, e nessuno dei due aggiunge una voce da scegliere.

9.10.1 Vicinanza nel tiro. Il danno del tiro cresce al diminuire della distanza dal bersaglio. La crescita è deterministica e calcolabile dal solo stato, e si stende fra due estremi dichiarati: la resa al limite della gittata e quella alla minima distanza; fra i due la formula unica interpola con continuità. La forma è una formula unica e i due estremi sono valori che risiedono nei file di dati (documento 03, punto 5.15).

9.10.1.0 Che cosa i due estremi devono valere, stabilito nella versione 3.6 sulla misura della fase C. Al limite della gittata il tiro DISTURBA: rende meno dell'accoppiamento nudo, e contro un bersaglio ben scelto le perdite che produce restano nella fascia più bassa del punto 9.7.2. Alla minima distanza il tiro UCCIDE: contro lo stesso bersaglio le perdite salgono alla fascia più alta. È la sostanza della doppia gittata soppressa nella versione 3.3, e la ragione per cui il modificatore era stato introdotto: prima della taratura la fascia annunciata non cambiava lungo l'intera gittata, sicché avvicinarsi non mutava nulla di ciò che il giocatore sentiva. Contro un bersaglio mal scelto il tiro non raggiunge la fascia più alta a nessuna distanza: la vicinanza non ripara l'accoppiamento sbagliato.

9.10.1.1 Il modificatore non tocca la disponibilità del bersaglio, che resta binaria secondo il punto 3.4.1, né aggiunge alcuna scelta al momento del tiro secondo il punto 3.4.1.1. L'azione di tiro resta una sola.

9.10.1.2 Conseguenza voluta e dichiarata: il modificatore premia chi ha l'iniziativa di avvicinarsi. Chi avanza sotto tiro paga il volume dell'avanzata e guadagna resa; chi resta fermo conserva il volume e tira meno forte. Vale identicamente per l'avversario, che avanzando guadagna quanto guadagnerebbe il giocatore. È lo scambio che la sezione intende creare, non un effetto collaterale da correggere.

9.10.2 Accerchiamento. Quando più reparti agiscono contro un medesimo reparto avversario, il danno che gli infliggono è accresciuto: moderatamente quando i concorrenti sono due, in misura assai maggiore quando sono tre o quattro. Oltre un tetto dichiarato nei dati la maggiorazione non cresce più. La forma è una formula unica e la sua misura è un passo che risiede nei file di dati, provvisorio fino alla taratura (documento 03, punto 5.16).

9.10.2.1 Insieme dei concorrenti. Contro un dato reparto concorrono i reparti della parte avversa che, nello stato corrente e per la sola loro posizione, lo hanno sotto la propria offesa: quelli a contatto di mischia con esso, quelli da mischia che gli sono adiacenti, e quelli da tiro che lo hanno entro la propria gittata effettiva. I tiratori concorrono quindi senza essere a contatto: diversamente l'accerchiamento condotto con i tiratori, che è manovra voluta, non produrrebbe alcun effetto.

9.10.2.2 Non concorre chi è trattenuto in una mischia che non comprende quel bersaglio: è impegnato altrove e non preme su di lui.

9.10.2.3 L'insieme si ricava dal solo stato e dalla sola posizione, letti nell'istante della risoluzione. Dentro UNA risoluzione non dipende dall'ordine in cui i danni si applicano, perché si calcola tutto prima di applicare alcunché. Dalla versione 3.7 non è più vero che l'insieme non dipenda dalle azioni già compiute nel turno: con la risoluzione immediata del punto 9.7.1 lo stato dell'istante è quello che le azioni precedenti hanno prodotto, ed è precisamente la profondità voluta dal punto 9.7.1.3. Resta fermo che l'insieme non dipende dalle scariche spese né dall'azione consumata, perché la posizione è la sola condizione. La scelta è deliberata e ha una ragione precisa: se il conteggio dipendesse dalle azioni già compiute, il primo a colpire riceverebbe una maggiorazione diversa dal secondo, e la risoluzione simultanea delle mischie del punto 9.7 cesserebbe di essere simultanea. Il costo dichiarato e accettato di questa scelta è che un reparto da tiro rimasto senza munizioni continua a concorrere finché tiene il bersaglio entro la propria gittata: è pur sempre un corpo schierato che ne minaccia il fianco, e la regola resta una sola e indipendente dall'ordine.

9.10.2.4 La maggiorazione si applica a chi stringe, mai a chi è stretto. Contro ciascuno dei propri assalitori il reparto accerchiato è a sua volta isolato, e non riceve quindi alcuna maggiorazione. L'asimmetria è il senso stesso del modificatore. Dalla versione 3.5 la frase si ferma qui: la versione 3.4 aggiungeva che «i suoi colpi restano quelli di sempre», il che non è più vero, poiché il limite dei bersagli simultanei del punto 9.11 riduce la risposta al secondo assalitore e la sopprime dal terzo. I due effetti sono distinti e si sommano: l'accerchiamento accresce ciò che gli assalitori infliggono, il limite riduce ciò che l'accerchiato restituisce.

9.10.2.5 Il modificatore vale tanto per la mischia quanto per il tiro, e si compone con quello di vicinanza: avvicinarsi a un bersaglio già stretto rende più che avvicinarsi a uno isolato.

9.10.3 Annuncio dei due modificatori. Entrambi devono essere percepibili, altrimenti sono numeri invisibili che nessuno può usare per decidere. Si annunciano nel momento in cui l'informazione serve a decidere, cioè quando si designa un bersaglio, e non soltanto nel racconto dell'esito; senza alcuna cifra, coerentemente con la scelta del punto 9.7.2; con termini del vocabolario chiuso. La forma esatta dell'annuncio è materia del documento 02, punti 4.4.5 e 9.3.

## 9 ter. Limite dei bersagli simultanei (sezione 9.11)

9.11 Introdotto nella versione 3.5 per decisione del titolare. Un reparto può rispondere contemporaneamente ad al massimo due nemici. Al primo risponde a piena resa; al secondo con una resa ridotta da un malus, perché è già impegnato altrove e si difende di lato; dal terzo in poi non risponde affatto, sicché chi arriva terzo o quarto colpisce senza essere colpito di ritorno. Il limite riguarda la RISPOSTA e non l'offesa: chi sopraggiunge infligge il proprio danno pieno anche quando non riceve nulla di ritorno.

9.11.1 Criterio dei posti. I posti si assegnano per ordine di arrivo del contatto, non per potenza del nemico né per posizione sul campo: chi ingaggia per primo occupa il primo posto, chi ingaggia dopo il secondo, gli altri restano fuori. L'ordine di arrivo è un fatto dello stato, determinato dalla sequenza dei comandi. Dalla versione 3.7 i posti si leggono dallo stato con cui si apre CIASCUNA risoluzione: quella immediata legge l'istante in cui il contatto si forma, quella d'inizio giro legge l'apertura del giro. Dentro una singola risoluzione i posti si leggono una volta sola e valgono identici per tutti i contatti che vi rientrano, sicché l'ordine in cui i danni si applicano non li tocca.

9.11.1.1 Conseguenza da non scoprire dopo: il posto di un reparto può cambiare fra una risoluzione e l'altra, perché nel frattempo un posto può essersi liberato. Chi arriva terzo non riceve risposta nell'istante in cui ingaggia; se prima della risoluzione d'inizio giro uno dei due che lo precedevano cade, vi succede secondo il punto 9.11.2 e da lì riceve risposta. È la successione già prevista, che ora può compiersi anche dentro un turno.

9.11.2 Successione nei posti liberati. Quando il nemico che occupava un posto esce di scena, perché distrutto o perché disingaggiato, il posto si riempie da sé, senza alcuna decisione del giocatore: chi è in mischia è fuori controllo secondo il punto 9.5, e una successione da ordinare contraddirebbe quella regola. Vi subentra il più anziano per ordine di arrivo fra quelli che restavano fuori, sicché chi era terzo diventa secondo e poi eventualmente primo. La regola è una sola e vale per entrambi i posti: il posto liberato dal secondo si comporta esattamente come quello liberato dal primo, e tutti scorrono in avanti di una posizione. Un comportamento diverso per i due posti sarebbe stato una seconda regola da imparare senza alcun guadagno.

9.11.2.1 Conseguenza sul disingaggio. Il reparto che non riceve risposta non subisce perdite in quel contatto, e la soglia di disingaggio del punto 9.8, che si misura sulle perdite subite in quel contatto, non scatta mai per lui: resta a contatto finché il bersaglio cade o finché un posto si libera e gli tocca. È coerente con il senso della soglia, che esprime lo scoraggiamento di chi sta perdendo, e chi colpisce senza essere colpito non sta perdendo.

9.11.3 Annuncio delle tre condizioni. Essere il terzo arrivato, cioè colpire senza ricevere risposta, cambia le decisioni, e chi vede la scena lo intuirebbe. Va quindi dichiarato quando serve a decidere, cioè al momento della designazione del bersaglio, e non soltanto nel racconto dell'esito. Le tre condizioni — fronteggiato a piena resa, contrastato di lato con resa ridotta, non contrastato affatto — si esprimono con tre termini del vocabolario chiuso, senza alcuna cifra. A differenza dell'accerchiamento, di cui al punto 9.10.2, qui si annunciano tutte e tre le condizioni compresa quella ordinaria: non sapere che il bersaglio risponderebbe a piena resa non è distinguibile dal non aver sentito nulla, e la differenza fra le tre è precisamente ciò su cui si decide. La forma dell'annuncio è materia del documento 02, punti 4.4.5 e 9.3.1.

9.11.4 Il limite vale per entrambe le parti senza eccezioni, e non è un vantaggio nascosto.

9.11.5 Avvertenza sul bilanciamento, registrata perché non vada perduta. Questa regola e il modificatore di accerchiamento del punto 9.10.2 lavorano nella stessa direzione e si sommano: il primo riduce ciò che l'accerchiato restituisce, il secondo accresce ciò che gli assalitori infliggono. L'avversario, che già ordina i bersagli per efficacia, imparerà a mandare i reparti dove non c'è risposta, e la differenza fra tre contro uno e uno contro uno è quindi molto maggiore di quanto fosse quando il moltiplicatore di accerchiamento è stato scelto. La misura dell'effetto congiunto e la proposta di revisione del moltiplicatore stanno nel documento 03, punto 6.10: sono valori e appartengono alla taratura, non a questo documento.
...
13.2 Vantaggi attualmente stabiliti: l'avversario può ritirare unità soltanto dalla propria riga più arretrata; la sua propensione alla ritirata è molto bassa; l'annientamento simultaneo non si risolve a sfavore del giocatore, secondo il punto 15.2.5 (aggiunto nella versione 3.5).
...
15.2.3.1 Modo di conclusione quando la ritirata è stata dichiarata, precisato nella versione 3.6 dopo una misura della fase C. Il punto 15.2.3 riserva l'annientamento al caso in cui «nessuno dei due si ritira». Dichiarata la resa, la conclusione è quindi governata dalla sola ritirata combattuta della sezione 10 e il modo è sempre la ritirata compiuta, anche quando il ritirante finisce per non avere più nulla in campo né nel mazzo: chi ha evacuato ha compiuto la ritirata, non è stato annientato, e raccontarglielo come un annientamento sarebbe falso. Lo sconfitto resta chi ha dichiarato la resa, secondo il punto 15.2.2, anche nel caso — non normato prima — in cui sia l'avanzante a restare senza nulla: la ritirata è riuscita, e si può perdere una battaglia avendo inflitto più danni di quanti se ne siano subiti.

15.2.5 Annientamento simultaneo, chiuso nella versione 3.5 per decisione del titolare. Quando l'ultimo reparto di ciascuna delle due parti cade nel medesimo giro, il punto 15.2.3 non basta a designare lo sconfitto e il punto 15.2.2 esclude la parità. L'esito è assegnato al giocatore: l'avversario risulta sconfitto. La regola è espressamente un vantaggio nascosto ai sensi della sezione 13 ed è iscritta al punto 13.2, poiché favorisce deliberatamente una delle due parti; risiede quindi nel file dei vantaggi nascosti e il programma di verifica può disattivarla per misurare le probabilità reali. La strada alternativa, cioè introdurre un esito di parità, è stata valutata e scartata: contraddirebbe frontalmente il punto 15.2.2 e obbligherebbe a rifare il resoconto, il ritorno in campagna dei punti da 15.4 a 15.6, che presuppongono un vincitore, e le registrazioni; assegnare l'esito tocca invece una sola riga di regola.
...
16.3.1 Aggiunti nella versione 3.4, da stabilire in sede di definizione dei valori: la misura della maggiorazione di vicinanza alla minima distanza e le soglie delle sue fasce descrittive, punto 9.10.1; il passo della maggiorazione di accerchiamento e il tetto dei concorrenti conteggiati, punto 9.10.2. Aggiunto nella versione 3.5: il malus della risposta al secondo bersaglio, punto 9.11. Il numero massimo di nemici cui si risponde è invece due ed è una regola, non un valore: come lo spostamento di una o al massimo due celle del punto 9.5.0.3, appartiene alla struttura, e renderlo un valore obbligherebbe a un malus per ciascun posto, cioè a una tabella, vietata dal punto 13.3 della carta.

16.4 Da tarare con le simulazioni prima della pubblicazione. Il margine di convenienza della ritirata combattuta, punto 10.9. Il rapporto tra volume disponibile e profondità concessa, che determina quanto pesi il vantaggio della sorpresa. La soglia minima di turni prima della resa, che determina la durata di una battaglia perduta, punto 10.10. Il carattere degli ufficiali avversari, che determina la frequenza effettiva degli scontri, punto 6.1.3. Il costo di mantenimento dei miglioramenti, unico freno automatico all'accumulo di forze, punto 4.14.1. L'ampiezza della fascia entro cui il tiro uccide, punto 3.4.1. Il peso dei due modificatori di posizione della sezione 9.10, aggiunto nella versione 3.4: quanto la vicinanza premi l'avanzata rispetto al costo in volume che essa comporta, e quanto l'accerchiamento debba pesare perché più reparti contro uno prevalgano senza che il campo si riduca a un ammassamento. La precisione dell'apporto informativo invernale in funzione di ricognizione, penetrazione e torri, punto 5.9.1.7. Il peso della fortezza in una campagna difensiva, punto 5.14.3.5, e lo sbilanciamento dei formati minori, punto 5.14.5.2.
