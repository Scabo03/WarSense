...
Documento 01 di 05 — versione 3.5
...
9.9.3 All'esito dell'accoppiamento si applicano i modificatori della sezione 9.10, che ne accrescono la resa e non la riducono mai. L'ordine è dichiarato: prima l'accoppiamento fra offesa e protezione, poi i modificatori, ciascuno come coefficiente di una formula unica secondo il punto 13.3 della carta. Nessun modificatore può rendere inefficace un'offesa che l'accoppiamento aveva reso efficace.
...
9.10.1 Vicinanza nel tiro. Il danno del tiro cresce al diminuire della distanza dal bersaglio. La crescita è deterministica e calcolabile dal solo stato: al limite della gittata la maggiorazione è nulla e la resa è quella dell'accoppiamento; alla minima distanza è massima; fra i due estremi cresce con continuità. La forma della crescita è una formula unica e la sua misura è un coefficiente che risiede nei file di dati, provvisorio fino alla taratura (documento 03, punto 5.15).
