...
Documento 01 di 05 — versione 3.4
...
9.10.2.4 La maggiorazione si applica a chi stringe, mai a chi è stretto. Contro ciascuno dei propri assalitori il reparto accerchiato è a sua volta isolato, e i suoi colpi restano quelli di sempre. L'asimmetria è il senso stesso del modificatore.
...
16.3.1 Aggiunti nella versione 3.4, da stabilire in sede di definizione dei valori: la misura della maggiorazione di vicinanza alla minima distanza e le soglie delle sue fasce descrittive, punto 9.10.1; il passo della maggiorazione di accerchiamento e il tetto dei concorrenti conteggiati, punto 9.10.2.
