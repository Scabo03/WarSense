...
Documento 01 di 05 — versione 3.6
...
9.11.1 Criterio dei posti. I posti si assegnano per ordine di arrivo del contatto, non per potenza del nemico né per posizione sul campo: chi ingaggia per primo occupa il primo posto, chi ingaggia dopo il secondo, gli altri restano fuori. L'ordine di arrivo è un fatto dello stato, determinato dalla sequenza dei comandi, e non dipende dall'ordine in cui i danni si applicano nella risoluzione simultanea del punto 9.7: i posti si leggono una volta sola dallo stato con cui il giro si apre, e valgono identici per tutti i contatti risolti in quel giro.
