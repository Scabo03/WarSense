...
9.9 Offesa e protezione. Il danno si ricava da coefficienti abbinati fra il tipo di munizione e il tipo di protezione, combinati da una formula unica, senza tabelle a doppia entrata, in applicazione del punto 13.3 della carta. La munizione poco adatta al bersaglio non è inefficace: infligge una frazione ridotta del danno.

9.9.1 L'annuncio al giocatore è qualitativo e non numerico: dichiara se la munizione sia efficace o poco efficace contro il bersaglio selezionato. Il modello sottostante resta graduato. L'accoppiamento netto, con la munizione inadatta resa del tutto inefficace, è stato valutato e scartato perché avrebbe reso possibile un esercito impossibile da ferire da lontano, rendendo irreversibili scelte di composizione compiute mesi prima sulla mappa di campagna.
